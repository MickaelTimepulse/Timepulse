...
import { Users, Search, Award, Hash, UserX } from 'lucide-react';
                  ...
                  return (
                    ...
                    >
                      <td className="py-2 px-3 text-center">
                        <div className="inline-flex items-center justify-center gap-1.5 bg-gradient-to-br from-blue-500 to-blue-600 text-white px-3 py-1.5 rounded-lg shadow-sm">
