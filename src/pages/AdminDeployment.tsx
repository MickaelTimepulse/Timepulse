        ...
        <div className="mb-12">
          ...
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-6 mb-6">
            <p className="text-gray-700">
              Bolt Database fait des backups automatiques quotidiens. Ce script affiche les informations
          ...
          <CommandBlock
            ...
            id="backup"
            description="Affiche le lien vers les backups Bolt Database"
          />
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-semibold text-gray-900">Bolt Database Dashboard</h3>
              </div>
